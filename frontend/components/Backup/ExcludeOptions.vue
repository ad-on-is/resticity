<template>
	...
	<div class="grid grid-cols-2 gap-10 p-10 bg-opacity-70 rounded-lg shadow-lg" :class="colorClass">
		<div class="">
			<h4 class="text-indigo-500">Exclude files and folders</h4>
			<p class="text-sm mb-3">Pattern for files and folders to exclude. One per line.</p>
			<UTextarea :rows="7" placeholder="foo/**/bar" v-model="filesAndFolders"></UTextarea>
			<h4 class="text-indigo-500 mt-10">File</h4>
			<p class="text-sm mb-3">Exclude items listed in specific files.</p>
		...
		<div>
			...
			<p class="text-sm mb-3">Excludes a folder if it contains any of these files.</p>
			...
			<p class="text-sm mb-3">Exclude files if they exceed a specific file size</p>
			<UButtonGroup>
