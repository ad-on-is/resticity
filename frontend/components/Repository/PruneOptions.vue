		...
		() => {
			emit(
				...
				[
					...
					keep.value.daily > 0 ? ['--keep-hourly', keep.value.daily] : [],
					keep.value.weekly > 0 ? ['--keep-hourly', keep.value.weekly] : [],
					keep.value.monthly > 0 ? ['--keep-hourly', keep.value.monthly] : [],
					keep.value.yearly > 0 ? ['--keep-hourly', keep.value.yearly] : [],
